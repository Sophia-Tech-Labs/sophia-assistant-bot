...
async function startBot() {
  ...
  if(subscription[0].plan !== "basic"){
    throw new Error("Plan Is not Basic.. Use the right bot");
  }
      ...
      try {
        ...
        if (connection === "close") {
          ...
          if (reason === DisconnectReason.loggedOut) {
            ...
            await db.query("UPDATE subscriptions SET status = $1 WHERE user_id = $2", ["inactive",checkUser[0].id]);
